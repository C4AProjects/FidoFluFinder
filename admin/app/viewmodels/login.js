define(['durandal/system', 'services/fidoDatacontext', 'durandal/app', 'viewmodels/shell', 'plugins/router', 'services/logger','models/fidoModels'],
    function (system,datacontext,app,shell,router,logger,models) {
        ...
        var onOk = function (result) {
            ...
            if (result.status === "success") {
                ...
                shell.currentUser=new models.UserModel(result.data);
